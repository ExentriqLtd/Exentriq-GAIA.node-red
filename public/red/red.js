	...
	var exentriqToken = null;
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $('#header').prepend('<div id="robot" class="robot" style="position:absolute;"><a id="robot-back" href="#" class="robot-back"><i class="material-icons">keyboard_arrow_left</i></a><a class="robot-name" href="#">'+robot_name+'</a></div>');
